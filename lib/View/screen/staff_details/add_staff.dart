                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  Expanded(
                                      child: CustomTextField(
                                    value: data.staffModel.overTimeHour?.toString() ?? "",
                                    labelText: "Hour",
                                    onChanged: (val) {
                                      data.staffModel.overTimeHour = val.toDouble();
                                    },
                                  )),
                                  const SizedBox(
                                    width: 10,
                                  ...
                                  Expanded(
                                      child: CustomTextField(
                                    value: data.staffModel.overTimeWage?.toString() ?? "",
                                    labelText: "Wage",
                                    onChanged: (val) {
                                      data.staffModel.overTimeWage = val.toDouble();
                                    },
                                  )),
                                ],
                              ),
