      ...
      child: Consumer<VehicleProvider>(builder: (context, data, _) {
        return Scaffold(
                  ...
                  children: [
                    Column(
                      children: [
                        ...
                        Text(val.vehicleType.toString(),style: AppFont.cardText,)
                      ],
                    ),
                    SizedBox(width: 5,),
                    Expanded(child: Column(
                      ...
                      children: [
                        ...
                        TitleTextWidget(title: "Driver", text: val.driverName.toString())
                      ],
                    )),
                    Column(
                      children: [
            ...
            floatingActionButton: CustomFloatingActionButton(onTap: () {
              Navigator.push(
                  context, MaterialPageRoute(builder: (_) => AddVehicle())).then((value) => data.getDataFromFireStore());
            }),
          );
        }
      ),
